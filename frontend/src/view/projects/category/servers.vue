...
<template>
  <div>
    ...
    <Modal v-model="createModal" width="500" title="创建服务器" @on-ok="handleCreate" @on-cancel="cancel">
    ...
    <Modal v-model="updateModal" width="500" :title="'修改服务器 (ID: ' + updateForm.id + ')'" @on-ok="handleUpdate"
      @on-cancel="cancel">
      <div class="formcontent">
        <Row>
          <Col span="22">
    ...
    <Modal v-model="deleteModal" width="450" :title="'删除服务器 (ID: ' + deleteData.id + ')'" @on-ok="handleDelete"
      @on-cancel="cancel">
      <div>
    ...
    <Modal v-model="fetchServerInfoModal" width="450" :title="'采集服务器信息 (ID: ' + serverInfoData.id + ')'"
      @on-ok="handleFetchServerInfo" @on-cancel="cancel">
      <div>
